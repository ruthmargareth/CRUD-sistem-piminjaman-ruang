...
class Dashboard extends CI_Controller {
	...
	{	
		...
		$this->data['count_ruangan']=$this->db->query("SELECT * FROM tb_ruangan")->num_rows();
		 $this->data['count_pinjam']=$this->db->query("SELECT * FROM tb_pinjam")->num_rows();
		...
		$this->load->view('footer_view',$this->data); //ga perlu
	}
