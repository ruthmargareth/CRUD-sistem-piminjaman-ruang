...
class Login extends CI_Controller {
	...
	{
		$this->data['title_web'] = 'Login | ROOOMS';
    ...
    public function auth()
    {
        ...
        $proses_login = $this->db->query("SELECT * FROM tb_admin WHERE user='$user' AND pass = '$pass'");
        ...
        if($row > 0)
        {
            ...
            $this->session->set_userdata('ses_id',$hasil_login['id_admin']);
