...
<html>
  ...
  <body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/lab.jpg');?>')no-repeat;background-size:100%;">
    <div class="login-box">
	    <br/>
      <div class="login-logo">
        <a href="index.php" style="color: black;"><b>WELCOME TO ROOOMS</b></a>
      </div>

      <div id="tampilalert"></div>

      <!-- login -->
      <div class="login-box-body" style="border:1px solid">
